...
.titleUl {
  ...
  .drop-down-container{
    ...
    .drop-down{
      ...
      left: -0.4rem;
      top: 1.33rem;
      background: rgba(2, 19, 45, 0.49);
      border: 0.06rem solid #085dba;
      width: 4.67rem;
      text-align: center;
      li:nth-of-type(1){
        padding-top: 0.42rem;
      ...
      li:hover{
        background:linear-gradient(180deg,rgba(227,229,229,1) 0%, rgba(56,206,223,1) 100%);
