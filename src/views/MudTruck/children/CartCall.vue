      ...
      <TitleUpperLine></TitleUpperLine>
       <div>
          <select name="" id="" class="select-road">
            ...
            <option value="">快速行驶</option>
            <option value="">急速行驶</option>
          </select>
       </div>
       <div class="car-call-chart" ref="callChart" :style="getStyles(500, 1650)">
...
export default {
  ...
  methods:{
    ...
    mounted(){
     ...
     this.echart = echarts.init(this.$refs.callChart);
     let option = {
       grid:{
        left: '5%',
        right: '5%',
